package com.hu.hospital.service.impl;

import com.alibaba.fastjson.JSONArray;
import com.alibaba.fastjson.JSONObject;
import com.hu.hospital.mapper.HospitalSetMapper;
import com.hu.hospital.mapper.ScheduleMapper;
import com.hu.hospital.model.HospitalSet;
import com.hu.hospital.model.Schedule;
import com.hu.hospital.service.ApiService;
import com.hu.hospital.util.BeanUtils;
import com.hu.hospital.util.HttpRequestHelper;
import com.hu.hospital.util.MD5;
import com.hu.hospital.util.YyghException;
...
public class ApiServiceImpl implements ApiService {
    ...
    public void saveBatchHospital() throws IOException {
        ...
        for (int i = 1, len = jsonArray.size(); i < len; i++) {
            ...
            paramMap.put("timestamp", HttpRequestHelper.getTimestamp());
            paramMap.put("sign", MD5.encrypt(apiService.getSignKey()));
